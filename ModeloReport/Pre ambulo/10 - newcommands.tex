...
%==================================================================
%Fonte
\newcommand{\conteudofonte}{Os autores (2024)}
...
\makeatletter
\def\ancoralongtable{\renewcommand{\fonte}[1][\conteudofonte]{Fonte: ##1}\renewcommand{\posfonte}{c}}
\def\ancoralongquadro{\ancoralongtable}
\makeatother
%==================================================================
%seção não numerada
...
%Formatar usando Lua
\ifdefined\directlua
	\directlua{require("Pre ambulo/10.1 - lua cmds.lua")}
